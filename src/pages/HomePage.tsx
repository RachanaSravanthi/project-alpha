...
export default function HomePage() {
  const { isLoaded, projectData, fadeIn, staggerChildren } =
    useOutletContext<HomePageProps>();
  const [selectedCategory, setSelectedCategory] =
    useState<string>("Motion Design");
  ...
  const handleProjectClick = (index: number) => {
    ...
    const projectIndexInOriginalData = projectData.findIndex(
      (p) => p.id === project.id
    );
                  ...
                  >
                    <iframe
                      ...
                      style={{
                        ...
                        maskImage:
                          "linear-gradient(to bottom, black 83%, transparent 100%)",
